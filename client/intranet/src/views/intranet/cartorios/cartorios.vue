  ...
  <v-app id="inspire">
    ...
    <v-navigation-drawer v-model="drawer" app style="text-align:center; padding-top:15px">
      ...
      >
        <v-list-item>
             <v-list-item-content>
            <router-link to="index" class="router-link black--text">Página Inicial</router-link>
          </v-list-item-content>
        </v-list-item>
      </v-list-item-group>
      ...
      >
        ...
        >
          <v-list-item-content >
             <router-link :to="child.rota" class="router-link black--text" v-text="child.title"></router-link>
          </v-list-item-content>
    ...
    <v-list >
      ...
      >
        <v-list-item>
             <v-list-item-content>
            <button  class="router-link black--text" @click="sairToLogin()">Sair</button>
          </v-list-item-content>
        </v-list-item>
      </v-list-item-group>
    </v-list>
  ...
  export default {
    data (){ 
       ...
       items: [
        {
          action: 'mdi-ticket',
          items: [{ title: 'Usuários', rota:""},{ title: "Cartórios",rota:"cartorios"}],
          title: 'Cadastros',
        },
        {
          action: 'mdi-ticket',
          items: [{ title: 'Opção 1', rota:"" },{ title: "Opção 2", rota:""}],
          title: 'Departamentos',
        },
